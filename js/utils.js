...
export const ICONS = {
  ...
  groups:   '<svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden="true"><circle cx="5" cy="5.5" r="2.2" stroke="currentColor" stroke-width="1.4"/><circle cx="13" cy="5.5" r="2.2" stroke="currentColor" stroke-width="1.4"/><path d="M1.5 13.5c0-2 1.6-3.2 3.5-3.2s3.5 1.2 3.5 3.2" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/><path d="M9.5 13.5c0-2 1.6-3.2 3.5-3.2s3.5 1.2 3.5 3.2" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/></svg>',
  grid4:    '<svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden="true"><rect x="2" y="2" width="6" height="6" rx="1.5" stroke="currentColor" stroke-width="1.4"/><rect x="10" y="2" width="6" height="6" rx="1.5" stroke="currentColor" stroke-width="1.4"/><rect x="2" y="10" width="6" height="6" rx="1.5" stroke="currentColor" stroke-width="1.4"/><rect x="10" y="10" width="6" height="6" rx="1.5" stroke="currentColor" stroke-width="1.4"/></svg>',
  personStar: '<svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden="true"><circle cx="8" cy="7.5" r="2.8" stroke="currentColor" stroke-width="1.5"/><path d="M2 16.5c0-3 2.5-5 6-5s6 2 6 5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M14.5 1.5l.55 1.65h1.7l-1.4 1.02.55 1.65-1.4-1.02-1.4 1.02.55-1.65-1.4-1.02h1.7z" fill="currentColor"/></svg>',
  ...
  games:    '<svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden="true"><rect x="2" y="2" width="14" height="14" rx="3" stroke="currentColor" stroke-width="1.5"/><circle cx="9" cy="9" r="1.3" fill="currentColor"/><circle cx="5.5" cy="5.5" r="1" fill="currentColor"/><circle cx="12.5" cy="5.5" r="1" fill="currentColor"/><circle cx="5.5" cy="12.5" r="1" fill="currentColor"/><circle cx="12.5" cy="12.5" r="1" fill="currentColor"/></svg>',
