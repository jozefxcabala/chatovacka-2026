...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: '12:30', label: 'Obed',                            type: 'jedlo'    },
      { time: '14:45', label: 'Scénka – Delegáti a Biela čarodejnica',   type: 'scenka',   sceneRef: 'sc-stv-2'      },
      { time: '14:45', label: 'Stretnutie Aslan & čarodejnica',  type: 'activity', activityRef: 'stv-aslan'   },
