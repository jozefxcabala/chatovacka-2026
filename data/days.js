...
export const days = [
  {
    ...
    schedule: [
      ...
      { time: '10:30', label: '"Pokladovka" + výroba erbov, pokriku', type: 'activity', activityRef: 'pon-pokladovka'   },
      { time: '11:15', label: 'Zoznamovačky',                  type: 'activity', activityRef: 'pon-zoznamovacky' },
      { time: '12:30', label: 'Obed',                          type: 'jedlo'    },
      { time: '13:30', label: 'Schovávačka',                  type: 'activity', activityRef: 'pon-schovavacka', note: '⚠ čas neznámy, odhadnutý' },
      { time: '14:30', label: 'Celotáborová hra – objavenie skrine', type: 'activity', activityRef: 'pon-skrinia' },
